...
#reviews_pred_train = cross_val_predict(clf_KNN,reviews_X_train, reviews_y_train)
#reviews_pred_validation = cross_val_predict(clf_KNN,reviews_X_validation, reviews_y_validation)
#reviews_pred_test = cross_val_predict(clf_KNN,reviews_X_test, reviews_y_test)
...
for k in range(1,31):
    ...
    #pred_train = pred_format_process(clf,X_train)
    #acc1 = acc(Y_train, pred_train)
    #acc_train.append(acc1)
    #pred_valid = pred_format_process(clf,X_valid)
    #acc2 = acc(Y_valid, pred_valid)
    #acc_valid.append(acc2)
    print(k)
...
# Accurancy Comparison among all the confusion matrix
#print(accuracy_df)
